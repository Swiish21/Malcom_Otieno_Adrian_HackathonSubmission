...
#simple test cases        
print(is_match("aa", "a"))  # False, we only need one occurence of the preceeding character not two.
print(is_match("aa", "a*"))  # True, the wildcard matches the occurences of the preceeding character.
print(is_match("ab", ".*"))  # True , because the wildcard matches one or more occurences of the preceeding character and the dot matches the preceeding character.
print(is_match("ab", "")) #False, because the pattern is empty and the text is not empty.
